...
public class Facebook {
	 ...
	 */
 	public static String removeQuotes(String s) {
		if (s.length() == 0 || (s.length() == 2 && s.substring(0,1).equals("\"") && s.substring(1).equals("\"")))
			return null;
	 ...
	 */
 	public static Object[] objs(String json, int multiple) {
		...
		if (multiple == 0) {
			if ((json.substring(0,1).equals("[") || json.substring(0,1).equals("{")) && objEnd(json) == json.length() -1)
	...
	private static Object[] getObjs(String json) {
		...
		if (!json.substring(0,1).equals("\"") && !json.substring(0,1).equals("{") && !json.substring(0,1).equals("["))
			return objs.toArray();
